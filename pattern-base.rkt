...
(define (skeleton->pattern def skel)
  ...
  (entity (list->mutlist (skeleton-handles skel))
          ...
          (lambda (w h)
            ...
            (apply (curry (locked-pattern-def-style def) (jointset-scale (skeleton-js skel)))
